...
def setup_buttons():
    ...
    Label(main_window, font=("Helvetica", 16), fg='gray100', bg='skyblue', text="Full Name", width=9, borderwidth=2, relief="sunken").grid(column=0,row=0,padx=6,sticky=E)
    Label(main_window, font=("Helvetica", 16), fg='gray100', bg='skyblue', text="Recipe Number", width=13, borderwidth=2, relief="sunken").grid(column=0,row=1,sticky=E)
    Label(main_window, font=("Helvetica", 19, "bold"), fg='gray100', bg='skyblue', text=counters['total_entries'], width=4, borderwidth=2, relief="sunken").grid(column=1,row=1)
    Label(main_window, font=("Helvetica", 16), fg='gray100', bg='skyblue', text="Forks", width=7, borderwidth=2, relief="sunken").grid(column=0,row=2,sticky=E)
    Label(main_window, font=("Helvetica", 16), fg='gray100', bg='skyblue', text="Spoons", width=8, borderwidth=2, relief="sunken").grid(column=3,row=2,sticky=W)
    Label(main_window, font=("Helvetica", 16), fg='gray100', bg='skyblue', text="Paper Plates", width=11, borderwidth=2, relief="sunken").grid(column=0,row=4,sticky=E)
    Label(main_window, font=("Helvetica", 16), fg='gray100', bg='skyblue', text="Paper Cups", width=10, borderwidth=2, relief="sunken").grid(column=3,row=4,sticky=W)
    Label(main_window, font=("Helvetica", 16), fg='gray100', bg='skyblue', text="Party Hats", width=10, borderwidth=2, relief="sunken").grid(column=0,row=6,sticky=E)
    Label(main_window, font=("Helvetica", 16), fg='gray100', bg='skyblue', text="Ballons", width=7, borderwidth=2, relief="sunken").grid(column=3,row=6,sticky=W)
    Label(main_window, font=("Helvetica", 16), fg='gray100', bg='skyblue', text="Hired Date", width=10, borderwidth=2, relief="sunken").grid(column=0,row=8,pady=20)          
    Label(main_window, font=("Helvetica", 16), fg='gray100', bg='skyblue', text="Row number", width=11, borderwidth=2, relief="sunken").grid(column=4,row=9)
...
name_entry = Entry(main_window, font=("Helvetica", 14), fg='gray100', bg='skyblue', width=15, borderwidth=1, relief="solid")
name_entry.grid(column=1,row=0)
item_1_forks = Spinbox(main_window, font=("Helvetica", 16, "bold"), fg='gray100', bg='skyblue', from_=0, to=100, width=3, repeatdelay=500, repeatinterval=100, borderwidth=1, relief="solid")
item_1_forks.grid(column=1,row=2)
item_2_spoons = Spinbox(main_window, font=("Helvetica", 16, "bold"), fg='gray100', bg='skyblue', from_=0, to=100, width=3, repeatdelay=500, repeatinterval=100, borderwidth=1, relief="solid")
item_2_spoons.grid(column=4,row=2)
item_3_Paper_Plates = Spinbox(main_window, font=("Helvetica", 16, "bold"), fg='gray100', bg='skyblue', from_=0, to=100, width=3, repeatdelay=500, repeatinterval=100, borderwidth=1, relief="solid")
item_3_Paper_Plates.grid(column=1,row=4)
item_4_Paprt_Cups = Spinbox(main_window, font=("Helvetica", 16, "bold"), fg='gray100', bg='skyblue', from_=0, to=100, width=3, repeatdelay=500, repeatinterval=100, borderwidth=1, relief="solid")
item_4_Paprt_Cups.grid(column=4,row=4)
item_5_Party_hats = Spinbox(main_window, font=("Helvetica", 16, "bold"), fg='gray100', bg='skyblue', from_=0, to=100, width=3, repeatdelay=500, repeatinterval=100, borderwidth=1, relief="solid")
item_5_Party_hats.grid(column=1,row=6)
item_6_Paprt_Ballons = Spinbox(main_window, font=("Helvetica", 16, "bold"), fg='gray100', bg='skyblue', from_=0, to=100, width=3, repeatdelay=500, repeatinterval=100, borderwidth=1, relief="solid")
item_6_Paprt_Ballons.grid(column=4,row=6)
hire_date = Spinbox(main_window, font=("Helvetica", 16, "bold"), fg='gray100', bg='skyblue', from_=0, to=100, width=3, repeatdelay=500, repeatinterval=100, borderwidth=1, relief="solid")
hire_date.grid(column=1,row=8)
delete_item = Entry(main_window, font=("Helvetica", 16, "bold"), fg='gray100', bg='skyblue', width=4, borderwidth=1, relief="solid")
